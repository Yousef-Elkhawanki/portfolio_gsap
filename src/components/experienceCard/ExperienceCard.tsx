...
export default function ExperienceCard({ title, company, date }: IExperienceCard) {
    return (
        <div className="experience-card py-8 xl:border-b border-gray-800 last-of-type:border-0 flex justify-between items-end flex-wrap gap-6 animated-text">
            <div className="experience-card-title flex items-end gap-6 flex-wrap">
                <span className="text-xs min-w-[150px]">{date}</span>
                <h3 className="xl:text-5xl text-2xl uppercase  font-antonio ">{company}</h3>
            </div>
