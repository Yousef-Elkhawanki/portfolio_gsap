...
export default function ExperienceCard({ title, company, date }: IExperienceCard) {
    return (
        <div className="experience-card py-8 xl:border-b border-gray-800 last-of-type:border-0 flex justify-between xl:items-end flex-wrap gap-6 animated-text xl:flex-row flex-col items-start">
